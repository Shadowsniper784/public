...
export default class WOKCommands extends EventEmitter {
  ...
  private _userdata: Map<number,any>
  ...
  public get config(): { [name: string]: string }
  public get userdata(): Map<string,any>
  ...
  public setConfig(guild: Guild | null, data:any): WOKCommands
  public getUserData(user: User | null): any
